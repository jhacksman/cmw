#!/bin/bash
# Trailing Brute Force Runner
# ~926M candidates (~1B), ~57 minutes runtime at 270k H/s
...
echo "[*] Starting trailing brute force attack (~926M candidates)"
echo "[*] Estimated runtime: ~57 minutes at 270k H/s"
echo "[*] Trailing: 0-4 chars from '0123456789!?~\`.' (54,241 patterns)"
echo "[*] Base patterns: ~17,080 phrase variations"
